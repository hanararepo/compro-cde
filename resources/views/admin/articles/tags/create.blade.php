<x-layouts.admin title="Create Article Tag">
    <div class="max-w-2xl mx-auto space-y-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-slate-900 tracking-tight">New Article Tag</h2>
                <p class="text-sm text-slate-500 mt-1">Add a new tag with English and Indonesian names.</p>
            </div>
        ...
        <form action="{{ route('admin.article-tags.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs space-y-5">
                ...
                <p class="text-xs text-slate-400 -mt-3">The URL slug will be auto-generated from the English name.</p>
            </div>
